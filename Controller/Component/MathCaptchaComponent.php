...
class MathCaptchaComponent extends Component {
  ...
  */
  private $choices = array(
    "&iquest;Cu&aacute;l es la suma de .:addition-problem:.?", 
    "&iquest;Qu&eacute; resulta de .:word-problem:. ?", 
    "&iquest;Qu&eacute; es .:problem:.?", 
    "&iquest;Cu&aacute;l es el resultado de .:word-problem:.?", 
    "&iquest;Qu&eacute; obtienes cuando .:word2-problem:.?" 
  ); 
  ...
  */
  private $placeholders = array(
    ...
    ".:operatorword-ing:." => array(
      "a&ntilde;adir .:number:. a" => "+",
      "multiplicar .:number:. por" => "*")
  );
  ...
  */
  public function getResult() {
    if ($this->firstnum === null|| $this->secondnum === null || $this->operator === null) 
      throw new ErrorException("MathCaptcha generaci&oacute;n fallada.");
