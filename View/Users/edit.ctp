<?php 
    $this->Html->addCrumb(__('Registro'), '/users/edit'.$id); 
...
<p class="ayuda">Los campos con un * son obligatorios. El Email lo es si quieres recibir noticias.</p>
    <div class="mizdo">
	<?php
		...
		echo $this->Form->input('email', array('label' => array('text' => '*Email: ', 'class' => 'alinea'), 'size'=>'20'));
