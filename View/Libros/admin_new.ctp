...
<?php 
	...
	<?php
        ...
        echo $this->Html->link(__('Nuevo Autor'), array('controller' => 'autores', 'action' => 'add'), array('class'=>'enlace-boton', 'target'=>'_blank'));
        ...
        echo $this->Html->link(__('Nuevo Tema'), array('controller' => 'temas', 'action' => 'add'), array('class'=>'enlace-boton', 'target'=>'_blank'));
    ?>
    </div>
	</fieldset>
