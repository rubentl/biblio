...
<?php echo $this->Form->create('Libro');?>
	<fieldset>
		<legend><?php echo __('Editar Libro'); ?></legend>
    <div class="mizdo">
	<?php
		...
		echo $this->Form->input('Autore',array('label' => array('text' => 'Autores: ', 'class' => 'alinea'), 'size'=>'6'));
		echo $this->Form->input('Tema', array('label' => array('text' => 'Temas: ', 'class'=>'alinea'), 'size'=>'6'));
?>
</div>
	</fieldset>
<div class="centrado"><p><?php echo $this->Form->end(__('Actualizar'));?></p></div>
