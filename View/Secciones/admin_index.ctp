<div class="secciones index">
	...
	<tr>
		...
		<td><?php echo h($seccione['Seccione']['borrado']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $seccione['Seccione']['id']), null, __('Are you sure you want to delete # %s?', $seccione['Seccione']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
